...
namespace BlazorCRUDApp.Client.Helpers
{
    public static class IJSRuntimeExtensions
    {
        ...
        {
            return js.InvokeVoidAsync("Swal.fire", title, sweetAlertMessageType.ToString());
        }
        ...
        public static ValueTask<string> GetFromLocalStorage(this IJSRuntime js, string key) => js.InvokeAsync<string>(
